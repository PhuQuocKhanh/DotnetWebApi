...
{
 // Validator cho ProductCreateDTO, chứa các rule khi tạo sản phẩm mới
    public class ProductCreateDTOValidator : AbstractValidator<ProductCreateDTO>
    {
        public ProductCreateDTOValidator()
        {
            // SKU: bắt buộc, theo regex, đúng 8 ký tự in hoa hoặc số
            RuleFor(p => p.SKU)
            ...
            // Price: > 0, tối đa 8 chữ số và 2 số thập phân
            RuleFor(p => p.Price)
