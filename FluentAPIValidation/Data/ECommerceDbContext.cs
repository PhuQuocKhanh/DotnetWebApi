...
namespace FluentAPIValidation.Data
{
    public class ECommerceDbContext : DbContext
    {
        ...
        {
            // Cấu hình many-to-many giữa Product và Tag với bảng trung gian "ProductTag"
            ...
            // Seed dữ liệu cho bảng trung gian ProductTag
